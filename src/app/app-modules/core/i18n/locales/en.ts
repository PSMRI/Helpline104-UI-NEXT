...
export const en = {
  ...
  'registration.col.abhaDetails': 'ABHA Details',
  'registration.col.action': 'Action',
  'registration.action.select': 'Select',
  'registration.action.cancel': 'Cancel',
  'registration.cancel.title': 'Cancel Call',
  'registration.cancel.message': 'Are you sure you want to cancel and start over? The call will not be ended.',
  'registration.abha.view': 'View',
  'registration.abha.title': 'ABHA Details',
  'registration.abha.notAvailable': 'ABHA details are not available for this beneficiary.',
  'registration.abha.sno': 'S.No.',
  'registration.abha.number': 'ABHA Number',
  'registration.abha.address': 'ABHA Address',
  'registration.abha.createdDate': 'Date of creation',
  'registration.abha.mode': 'ABHA generation mode',
  'registration.abha.close': 'Close',
  ...
  'registration.success.mobileNumber': 'Mobile number',
  'registration.success.mobileNumberError': 'Enter a valid 10-digit mobile number.',
  'registration.success.sendSms': 'Send SMS',
  'registration.success.close': 'Close',
  'registration.success.smsSent': 'SMS sent.',
  'registration.continueHao.title': 'Confirm',
  'registration.continueHao.message': 'Do you want to proceed to Health Advisory?',
  ...
  'registration.village.none': 'No villages found for this block.',
  ...
  'cdss.symptomsTitle': 'Symptoms',
  'cdss.symptomResultsTitle': 'Symptom Results',
  'cdss.diseasesTitle': 'Diseases',
  'cdss.result': 'Result',
  'cdss.save': 'Save',
  'cdss.colSave': 'Save',
  'cdss.colDisease': 'Disease',
  'cdss.colCount': 'Count',
  'cdss.colInformation': 'Information',
  'cdss.colDosDonts': 'Dos & Donts',
  'cdss.colSelfCare': 'Self-Care',
  'cdss.colAction': 'Action',
  'cdss.emergencyTag': '[Emergency]',
  ...
  'prescription.drugRequired': 'Drug is required.',
  'prescription.drugGroup': 'Drug group',
  'prescription.drugGroupRequired': 'Drug group is required.',
  'prescription.strength': 'Strength',
  'prescription.strengthRequired': 'Strength is required.',
  'prescription.route': 'Route / usage',
  'prescription.frequency': 'Frequency',
  'prescription.frequencyRequired': 'Frequency is required.',
  ...
  'prescription.save': 'Save',
  'prescription.saveAndSend': 'Save & Send',
  'prescription.closeConfirm': 'Are you sure want to close?',
  'prescription.saved': 'Prescription saved.',
  'prescription.savedPrefix': 'Prescription saved successfully, Prescription ID is ',
  ...
  'casesheetHistory.show': 'History',
  'casesheetHistory.hide': 'Hide history',
  'casesheetHistory.tabOwn': '104 History',
  'casesheetHistory.tabMcts': 'MCTS History',
  'casesheetHistory.tabMmu': 'E-Health Facility History',
  'casesheetHistory.tabTm': 'TM History',
  ...
  'casesheetHistory.own.id': 'Id',
  'casesheetHistory.own.name': 'Name',
  'casesheetHistory.own.age': 'Age',
  'casesheetHistory.own.date': 'Date',
  'casesheetHistory.own.presentChiefComplaint': 'Present Chief Complaint',
  'casesheetHistory.own.diseaseSummary': 'Disease Summary',
  'casesheetHistory.own.symptoms': 'Symptoms',
  'casesheetHistory.own.provisionalSelectedDiagnosis': 'Provisional / Selected Diagnosis',
  'casesheetHistory.own.riskLevel': 'Risk Level',
  'casesheetHistory.own.informationGiven': 'Information Given',
  'casesheetHistory.own.recommendedAction': 'Recommended Action',
  'casesheetHistory.own.actionByHao': 'Action by HAO',
  'casesheetHistory.own.actionByMo': 'Action by MO',
  'casesheetHistory.own.treatmentRecommendation': 'Treatment Recommendation',
  'casesheetHistory.own.actionByPd': 'Action By PD',
  ...
  'roleWorkspace.stepService': 'Provide Service',
  'roleWorkspace.stepClosure': 'Closure',
  'roleWorkspace.cancel': 'Cancel',
  'roleWorkspace.proceedToClosure': 'Closure',
  ...
  'hao.caseSheet.chiefComplaints': 'Present Chief Complaint',
  ...
  'hao.caseSheet.provisionalDiagnosis': 'Provisional / Selected Diagnosis',
  'hao.caseSheet.provisionalDiagnosisPlaceholder': 'Filled automatically from the chief complaint',
  'hao.caseSheet.selectDiagnosis': 'Select a diagnosis',
  'hao.caseSheet.remarks': 'Remarks',
  'hao.caseSheet.save': 'Save',
  'hao.caseSheet.max200': 'Maximum 200 characters',
  'hao.caseSheet.clear': 'Clear',
  'hao.caseSheet.resendPrescription': 'Resend Prescription',
  'hao.caseSheet.resendPrescriptionHint': "Last five days' prescription if any",
  ...
  'hao.caseSheet.selectGender': 'Select gender',
  'hao.caseSheet.genderMale': 'Male',
  'hao.caseSheet.genderFemale': 'Female',
  'hao.caseSheet.genderTransgender': 'Transgender',
  'hao.caseSheet.age': 'Age',
  'hao.caseSheet.ageUnit': 'Age Unit',
  'hao.caseSheet.ageUnitDays': 'Day(s)',
  'hao.caseSheet.ageUnitMonths': 'Month(s)',
  'hao.caseSheet.ageUnitYears': 'Year(s)',
  'hao.caseSheet.dob': 'Date of Birth',
  'hao.caseSheet.presentChiefComplaint': 'Present Chief Complaint',
  'hao.caseSheet.diseasesSummary': 'Diseases Summary',
  'hao.caseSheet.informationGiven': 'Information Given',
  'hao.caseSheet.recommendedAction': 'Recommended Action',
  ...
  'hao.caseSheet.no': 'No',
  'hao.caseSheet.travelledLast14Days': 'Have you travelled in the last 14 days?',
  'hao.caseSheet.travelDomestic': 'Domestic',
  'hao.caseSheet.travelInternational': 'International',
  'hao.caseSheet.modeOfTravel': 'Mode of Travel',
  'hao.caseSheet.modeBus': 'Bus',
  'hao.caseSheet.modeTrain': 'Train',
  'hao.caseSheet.modeFlight': 'Flight',
  'hao.caseSheet.modeShip': 'Ship',
  'hao.caseSheet.travelledFrom': 'Travelled from',
  'hao.caseSheet.travelledTo': 'Travelled to',
  'hao.caseSheet.symptoms': 'Symptoms',
  'hao.caseSheet.fever': 'Fever',
  'hao.caseSheet.cough': 'Cough',
  'hao.caseSheet.breathingDifficulties': 'Breathing Difficulties',
  'hao.caseSheet.noSymptoms': 'No Symptoms',
  'hao.caseSheet.covid19ContactHistory': 'COVID-19 Contact History',
  'hao.caseSheet.contactConfirmedCase': 'Is a confirmed case of COVID-19',
  'hao.caseSheet.contactSymptomatic': 'Is having symptoms of Fever, Cough or breathing difficulty',
  'hao.caseSheet.contactTravelHistory': 'Has a history of travel to places reporting local transmission',
  'hao.caseSheet.seekMedicalConsultation': 'Seek medical consultation?',
  'hao.caseSheet.covidVaccineStatus': 'Covid Vaccine Status',
  'hao.caseSheet.ageGroup': 'Age Group',
  'hao.caseSheet.ageGroupAdult': '>= 12 years',
  'hao.caseSheet.ageGroupChild': '< 12 years',
  'hao.caseSheet.isApplicableForVaccine': 'Applicability for Vaccine',
  'hao.caseSheet.applicableForVaccination': 'Applicable for Vaccination',
  'hao.caseSheet.notApplicableForVaccination': 'Not Applicable for Vaccination',
  'hao.caseSheet.vaccineStatus': 'Vaccine Status',
  'hao.caseSheet.vaccineTypes': 'Vaccine Type',
  'hao.caseSheet.doseTaken': 'Dose Taken',
  ...
  'hao.caseSheet.category': 'Category',
  'hao.caseSheet.selectCategory': 'Select category',
  'hao.caseSheet.subCategory': 'Sub Category',
  'hao.caseSheet.selectSubCategory': 'Select sub category',
  'hao.caseSheet.getGuidelines': 'Get guidelines',
  'hao.caseSheet.noDocumentAvailable': 'No document available',
  'hao.caseSheet.provisionalDiagnosisRequired': 'Provisional diagnosis is required.',
  'hao.caseSheet.provisionalDiagnosisTooShort': 'Enter at least 4 characters.',
  'hao.caseSheet.riskLevel': 'Risk Level',
  'hao.caseSheet.riskLevelMild': 'Mild',
  'hao.caseSheet.riskLevelModerate': 'Moderate',
  'hao.caseSheet.riskLevelHigh': 'High',
  'hao.caseSheet.treatmentRecommendation': 'Treatment Recommendation',
  'hao.caseSheet.treatmentRecommendationRequired': 'Enter at least 3 characters.',
  ...
  'hao.closure.feature': 'Feature',
  'hao.closure.selectFeature': 'Select feature',
  'hao.closure.followUpDate': 'Follow-up Date',
  'hao.closure.followUpDateRequired': 'Follow-up date is required.',
  'hao.closure.caste': 'Caste',
  'hao.closure.selectCaste': 'Select caste',
  'hao.closure.education': 'Education',
  'hao.closure.selectEducation': 'Select education',
  'hao.closure.externalReferral': 'External Referral',
  'hao.closure.selectExternalReferral': 'Select',
  'hao.closure.yes': 'Yes',
  'hao.closure.no': 'No',
  ...
  'hao.closure.transferService': 'Transfer Call',
  ...
  'hao.closure.configureMoCampaign': 'Please configure the Medical campaign.',
  'hao.closure.configureCampaignGeneric': 'Please configure a campaign for this service.',
  'hao.closure.transferSkill': 'Skill',
  'hao.closure.selectSkill': 'Select skill',
  'hao.closure.transfer': 'Transfer Call',
  ...
  'hihl.otherChiefComplaint': 'Other Chief Complaint',
  'hihl.duration': 'Duration',
  'hihl.unitOfDuration': 'Unit of Duration',
  'hihl.durationUnit.Hours': 'Hour(s)',
  'hihl.durationUnit.Days': 'Day(s)',
  'hihl.durationUnit.Weeks': 'Week(s)',
  'hihl.durationUnit.Months': 'Month(s)',
  'hihl.durationUnit.Years': 'Year(s)',
  'hihl.description': 'Description',
  'hihl.remove': 'Remove',
  'hihl.add': 'Add',
  'hihl.impactOnPatient': 'Impact on Patient',
  'hihl.biologicalFunctioning': 'Biological Functioning',
  'hihl.appetite': 'Appetite',
  'hihl.sleep': 'Sleep',
  'hihl.bowel': 'Bowel',
  'hihl.libido': 'Libido',
  'hihl.hygieneAndTakingCare': 'Hygiene and Taking Care',
  'hihl.bladder': 'Bladder',
  'hihl.occupationalFunctioning': 'Occupational Functioning',
  'hihl.goingToWork': 'Going to Work',
  'hihl.issuesAtWorkplace': 'Issues at Workplace',
  'hihl.socialFunctioning': 'Social Functioning',
  'hihl.doingOfHouseholdWork': 'Doing of Household Work',
  'hihl.gettingAlongWithFamily': 'Getting Along with Family, Friends, Neighbours, and Colleagues',
  'hihl.possiblePrecipitatingFactor': 'Possible Precipitating Factor(s)',
  'hihl.otherPrecipitatingFactor': 'Other Precipitating Factor',
  'hihl.treatmentDetails': 'Treatment Details',
  'hihl.relationshipOfCurrentIllness': 'Relationship of Current Illness on Concurrent Medical Condition',
  'hihl.pastHistory': 'Past History',
  'hihl.pastPsychiatricCondition': 'Past Psychiatric Condition',
  'hihl.otherPastPsychiatricCondition': 'Other Psychiatric Condition',
  'hihl.typeOfTreatment': 'Type of Treatment',
  'hihl.psychiatricDrugsDetails': 'Psychiatric Drugs / Medication Details',
  'hihl.drugDetailsHint': 'Drug Name-Strength-Dosage-Frequency-Duration',
  'hihl.course': 'Course',
  'hihl.progress': 'Progress',
  'hihl.pastMedicalCondition': 'Past Medical Condition',
  'hihl.otherPastMedicalCondition': 'Other Past Medical Condition',
  'hihl.currentMedicationHistory': 'Current Medication History',
  'hihl.currentDrugs': 'Current Drugs',
  ...
  'hihl.save': 'Save',
  'hihl.history': 'History',
  'hihl.hideHistory': 'Hide History',
  'hihl.durationGreaterThanAge': 'Duration cannot be greater than the beneficiary’s age.',
  'hihl.confirmRemove': 'Are you sure you want to remove this entry?',
  'hihl.saveSuccess': 'Case sheet saved successfully.',
  'hihl.saveError': 'Could not save the case sheet. Please try again.',
  'hihl.history.id': 'ID',
  'hihl.history.gettingAlongWithFamily': 'Getting Along With Family',
  'hihl.history.precipitatingFactors': 'Possible Precipitating Factor(s)',
  'hihl.history.concurrentMedicalCondition': 'Concurrent Medical Condition',
  'hihl.history.pastMedicalConditions': 'Past Medical Conditions',
  'hihl.history.currentDrugsMedication': 'Current Drugs Medication',
  'hihl.history.conditionsInFamily': 'Conditions In Family',
  'hihl.history.loading': 'Loading history…',
  'hihl.history.noRecordFound': 'No record found.',
