...
export const as: Record<TranslationKey, string> = {
  ...
  'registration.col.abhaDetails': 'ABHA বিৱৰণ',
  'registration.col.action': 'কাৰ্য',
  'registration.action.select': 'বাছনি কৰক',
  'registration.action.cancel': 'বাতিল কৰক',
  'registration.cancel.title': 'কল বাতিল কৰক',
  'registration.cancel.message': 'আপুনি বাতিল কৰি পুনৰাই আৰম্ভ কৰিব বিচাৰেনে? কলটো শেষ নহ\'ব।',
  'registration.abha.view': 'চাওক',
  'registration.abha.title': 'ABHA বিৱৰণ',
  'registration.abha.notAvailable': 'এই হিতাধিকাৰীৰ বাবে ABHA বিৱৰণ উপলব্ধ নাই।',
  'registration.abha.sno': 'ক্ৰম',
  'registration.abha.number': 'ABHA নম্বৰ',
  'registration.abha.address': 'ABHA ঠিকনা',
  'registration.abha.createdDate': 'সৃষ্টিৰ তাৰিখ',
  'registration.abha.mode': 'ABHA সৃষ্টি ম\'ড',
  'registration.abha.close': 'বন্ধ কৰক',
  ...
  'registration.success.mobileNumber': "ম'বাইল নম্বৰ",
  'registration.success.mobileNumberError': "অনুগ্ৰহ কৰি এটা বৈধ ১০-সংখ্যাৰ ম'বাইল নম্বৰ দিয়ক।",
  'registration.success.sendSms': 'এছএমএছ পঠিয়াওক',
  'registration.success.close': 'বন্ধ কৰক',
  'registration.success.smsSent': "এছএমএছ পঠিওৱা হ'ল।",
  'registration.continueHao.title': 'নিশ্চিত কৰক',
  'registration.continueHao.message': 'আপুনি স্বাস্থ্য পৰামৰ্শলৈ আগবাঢ়িব বিচাৰেনে?',
  ...
  'registration.village.none': 'এই ব্লকৰ বাবে কোনো গাঁও পোৱা নগ’ল।',
  ...
  'cdss.symptomsTitle': 'লক্ষণবোৰ',
  'cdss.symptomResultsTitle': 'লক্ষণৰ ফলাফল',
  'cdss.diseasesTitle': 'ৰোগ',
  'cdss.result': 'ফল',
  'cdss.save': 'সংৰক্ষণ কৰক',
  'cdss.colSave': 'সংৰক্ষণ কৰক',
  'cdss.colDisease': 'বেমাৰ',
  'cdss.colCount': 'গণনা',
  'cdss.colInformation': 'তথ্য',
  'cdss.colDosDonts': 'কৰিব লগা আৰু কৰিব লগা ডণ্ট',
  'cdss.colSelfCare': 'আত্ম-যত্ন',
  'cdss.colAction': 'কাৰ্য্য',
  'cdss.emergencyTag': '[জৰুৰীকালীন]',
  ...
  'prescription.drugRequired': 'ঔষধ আৱশ্যক।',
  'prescription.drugGroup': 'ঔষধ গোট',
  'prescription.drugGroupRequired': 'ঔষধ গোট আৱশ্যক।',
  'prescription.strength': 'মাত্ৰা',
  'prescription.strengthRequired': 'মাত্ৰা আৱশ্যক।',
  'prescription.route': 'সেৱন পদ্ধতি',
  'prescription.frequency': 'পুনৰাবৃত্তি',
  'prescription.frequencyRequired': 'পুনৰাবৃত্তি আৱশ্যক।',
  ...
  'prescription.save': 'সংৰক্ষণ কৰক',
  'prescription.saveAndSend': 'সংৰক্ষণ কৰক আৰু প্ৰেৰণ কৰক',
  'prescription.closeConfirm': 'আপুনি নিশ্চিতভাৱে বন্ধ কৰিব বিচাৰে নেকি?',
  'prescription.saved': 'প্ৰেছক্ৰিপচন সংৰক্ষিত হ’ল।',
  'prescription.savedPrefix': 'প্ৰেছক্ৰিপশ্বন সফলতাৰে সংৰক্ষণ কৰা হৈছে, প্ৰেছক্ৰিপচন আইডি হৈছে ',
  ...
  'prescription.alternateNumber': 'বৈকল্পিক সংখ্যা',
  ...
  'casesheetHistory.show': 'ইতিহাস',
  'casesheetHistory.hide': 'ইতিহাস লুকুৱাওক',
  'casesheetHistory.tabOwn': '১০৪ ইতিহাস',
  'casesheetHistory.tabMcts': 'এমচিটিএছ ইতিহাস',
  'casesheetHistory.tabMmu': 'ই-স্বাস্থ্য সুবিধাইতিহাস',
  'casesheetHistory.tabTm': 'টিএম ইতিহাস',
  ...
  'casesheetHistory.own.title': '104 কেছ শ্বীটৰ ইতিহাস',
  'casesheetHistory.own.id': 'আইডি',
  'casesheetHistory.own.name': 'নাম',
  'casesheetHistory.own.age': 'বয়স',
  'casesheetHistory.own.date': 'তাৰিখ',
  'casesheetHistory.own.presentChiefComplaint': 'বৰ্তমানৰ মুখ্য অভিযোগ',
  'casesheetHistory.own.diseaseSummary': 'ৰোগৰ সাৰাংশ',
  'casesheetHistory.own.symptoms': 'লক্ষণবোৰ',
  'casesheetHistory.own.provisionalSelectedDiagnosis': 'অস্থায়ী / নিৰ্বাচিত ৰোগ নিৰ্ণয়',
  // Legacy leaves these two untranslated (Hindi.json/Assamese.json).
  'casesheetHistory.own.riskLevel': 'Risk Level',
  'casesheetHistory.own.informationGiven': 'প্ৰদান কৰা তথ্য',
  'casesheetHistory.own.recommendedAction': 'অনুমোদিত কাৰ্য্য',
  'casesheetHistory.own.actionByHao': 'এইচ.এ.ও.-ৰ দ্বাৰা কাৰ্য',
  'casesheetHistory.own.actionByMo': 'এম.ও.-ৰ দ্বাৰা কাৰ্য',
  'casesheetHistory.own.treatmentRecommendation': 'Treatment Recommendation',
  'casesheetHistory.own.actionByPd': 'পিডিৰ দ্বাৰা কাৰ্য',
  ...
  'supervisor.nav.blockUnblock': 'নম্বৰ ব্লেকলিষ্ট কৰক',
  ...
  'supervisor.nav.bloodUrl': 'ব্লাড ইউআৰএল',
  'supervisor.nav.callReports': 'কল প্ৰতিবেদন',
  'supervisor.nav.reportsGroup': 'প্ৰতিবেদন',
  ...
  'supQa.title': 'গুণগত মান নিৰীক্ষা (কল অডিটিং)',
  'supQa.filter.inboundOutbound': 'ইনবাউণ্ড / আউটবাউণ্ড কল',
  'supQa.inbound': 'ইনবাউণ্ড',
  'supQa.outbound': 'আউটবাউণ্ড',
  'supQa.filter.phone': 'হিতাধিকাৰীৰ ফোন নম্বৰ',
  'supQa.phoneInvalid': 'বৈধ 10–12 সংখ্যাৰ ফোন নম্বৰ দিয়ক।',
  'supQa.col.sno': 'ক্ৰমিক নং',
  'supQa.col.callId': 'কল আইডি',
  'supQa.col.callTime': 'কলৰ তাৰিখ আৰু সময়',
  'supQa.col.beneficiaryId': 'হিতাধিকাৰী আইডি',
  'supQa.col.name': 'হিতাধিকাৰীৰ নাম',
  'supQa.col.phone': 'হিতাধিকাৰীৰ ফোন নম্বৰ',
  'supQa.col.remarks': 'কলৰ মন্তব্য',
  'supQa.col.callType': 'কলৰ প্ৰকাৰ',
  'supQa.col.voice': 'ভইচ ৰেকৰ্ড',
  'supQa.play': 'বজাওক',
  'supQa.audioError': 'ভইচ ফাইলৰ পথ পোৱা নগ’ল।',
  'supQa.page': 'পৃষ্ঠা',
  'supQa.of': 'ৰ ভিতৰত',
  'supQa.prev': 'আগৰ',
  'supQa.next': 'পৰৱৰ্তী',
  ...
  'feedback.categoriesError': 'শ্ৰেণী ল’ড কৰিব পৰা নগ’ল। অনুগ্ৰহ কৰি পুনৰ চেষ্টা কৰক।',
  'feedback.submitError': 'মতামত জমা দিব পৰা নগ’ল। অনুগ্ৰহ কৰি পুনৰ চেষ্টা কৰক।',
  ...
  'roleWorkspace.stepService': 'সেৱা প্ৰদান কৰক',
  'roleWorkspace.stepClosure': 'সমাপ্তি',
  'roleWorkspace.cancel': 'বাতিল কৰক',
  'roleWorkspace.proceedToClosure': 'বন্ধ কৰা হৈছে',
  ...
  'hao.caseSheet.chiefComplaints': 'বৰ্তমানৰ মুখ্য অভিযোগ',
  ...
  'hao.caseSheet.provisionalDiagnosis': 'অস্থায়ী / নিৰ্বাচিত ৰোগ নিৰ্ণয়',
  'hao.caseSheet.provisionalDiagnosisPlaceholder': 'মুখ্য অভিযোগৰ পৰা স্বয়ংক্ৰিয়ভাৱে ভৰোৱা হয়',
  'hao.caseSheet.selectDiagnosis': 'নিৰ্ণয় বাছনি কৰক',
  'hao.caseSheet.remarks': 'মন্তব্য',
  'hao.caseSheet.save': 'সংৰক্ষণ কৰক',
  // Legacy has no Assamese string for this hint; it renders the English one.
  'hao.caseSheet.max200': 'Maximum 200 characters',
  'hao.caseSheet.clear': 'পৰিষ্কাৰ কৰক',
  'hao.caseSheet.resendPrescription': 'প্ৰেছক্ৰিপচন পুনৰ প্ৰেৰণ কৰক',
  ...
  'hao.caseSheet.selectGender': 'লিংগ বাছনি কৰক',
  'hao.caseSheet.genderMale': 'পুৰুষ',
  'hao.caseSheet.genderFemale': 'মহিলা',
  'hao.caseSheet.genderTransgender': 'ট্ৰেন্সজেণ্ডাৰ',
  'hao.caseSheet.age': 'বয়স',
  'hao.caseSheet.ageUnit': 'বয়সৰ একক',
  'hao.caseSheet.ageUnitDays': 'দিন',
  'hao.caseSheet.ageUnitMonths': 'মাহ',
  'hao.caseSheet.ageUnitYears': 'বছৰ',
  'hao.caseSheet.dob': 'জন্ম তাৰিখ',
  'hao.caseSheet.presentChiefComplaint': 'বৰ্তমানৰ মুখ্য অভিযোগ',
  'hao.caseSheet.diseasesSummary': 'ৰোগৰ সাৰাংশ',
  'hao.caseSheet.informationGiven': 'দিয়া তথ্য',
  'hao.caseSheet.recommendedAction': 'পৰামৰ্শিত ব্যৱস্থা',
  ...
  'hao.caseSheet.ageRequired': 'বয়স আৱশ্যক।',
  'hao.caseSheet.covidQc': 'COVID19 (QC)',
  'hao.caseSheet.yes': 'হয়',
  'hao.caseSheet.no': 'নহয়',
  'hao.caseSheet.travelledLast14Days': 'আপুনি যোৱা 14 দিনত ভ্ৰমণ কৰিছেনে?',
  'hao.caseSheet.travelDomestic': 'অভ্যন্তৰীণ',
  'hao.caseSheet.travelInternational': 'আন্তঃৰাষ্ট্ৰীয়',
  'hao.caseSheet.modeOfTravel': 'ভ্ৰমণৰ ধৰণ',
  'hao.caseSheet.modeBus': 'বাছ',
  'hao.caseSheet.modeTrain': 'ৰেল',
  'hao.caseSheet.modeFlight': 'বিমান',
  'hao.caseSheet.modeShip': 'জাহাজ',
  'hao.caseSheet.travelledFrom': 'ইয়াৰ পৰা ভ্ৰমণ কৰিছিল',
  'hao.caseSheet.travelledTo': 'ইয়ালৈ ভ্ৰমণ কৰিছিল',
  'hao.caseSheet.symptoms': 'লক্ষণ',
  'hao.caseSheet.fever': 'জ্বৰ',
  'hao.caseSheet.cough': 'কাহ',
  'hao.caseSheet.breathingDifficulties': 'উশাহ-বতাহৰ অসুবিধা',
  'hao.caseSheet.noSymptoms': 'কোনো লক্ষণ নাই',
  'hao.caseSheet.covid19ContactHistory': 'COVID-19 সংস্পৰ্শৰ ইতিহাস',
  'hao.caseSheet.contactConfirmedCase': 'COVID-19ৰ নিশ্চিত ৰোগী',
  'hao.caseSheet.contactSymptomatic': 'জ্বৰ, কাহ বা উশাহ-বতাহৰ অসুবিধাৰ লক্ষণ আছে',
  'hao.caseSheet.contactTravelHistory': 'স্থানীয় সংক্ৰমণৰ সূচনা হোৱা ঠাইলৈ ভ্ৰমণৰ ইতিহাস আছে',
  'hao.caseSheet.seekMedicalConsultation': 'চিকিৎসা পৰামৰ্শ লওক?',
  'hao.caseSheet.covidVaccineStatus': 'কভিড টিকাৰ অৱস্থা',
  'hao.caseSheet.ageGroup': 'বয়সৰ গোট',
  'hao.caseSheet.ageGroupAdult': '>= 12 বছৰ',
  'hao.caseSheet.ageGroupChild': '< 12 বছৰ',
  'hao.caseSheet.isApplicableForVaccine': 'টিকাৰ বাবে যোগ্যতা',
  'hao.caseSheet.applicableForVaccination': 'টিকাকৰণৰ বাবে যোগ্য',
  'hao.caseSheet.notApplicableForVaccination': 'টিকাকৰণৰ বাবে যোগ্য নহয়',
  'hao.caseSheet.vaccineStatus': 'টিকাৰ অৱস্থা',
  'hao.caseSheet.vaccineTypes': 'টিকাৰ প্ৰকাৰ',
  'hao.caseSheet.doseTaken': 'লোৱা ডজ',
  ...
  'hao.caseSheet.category': 'শ্ৰেণী',
  'hao.caseSheet.selectCategory': 'শ্ৰেণী বাছক',
  'hao.caseSheet.subCategory': 'উপ-শ্ৰেণী',
  'hao.caseSheet.selectSubCategory': 'উপ-শ্ৰেণী বাছক',
  'hao.caseSheet.getGuidelines': 'নিৰ্দেশনা লাভ কৰক',
  'hao.caseSheet.noDocumentAvailable': "কোনো দস্তাবেজ উপলব্ধ নাই",
  'hao.caseSheet.provisionalDiagnosisRequired': 'অস্থায়ী নিদান আৱশ্যক।',
  'hao.caseSheet.provisionalDiagnosisTooShort': 'অতি কমেও ৪টা আখৰ দিয়ক।',
  'hao.caseSheet.riskLevel': 'জোখিমৰ স্তৰ',
  'hao.caseSheet.riskLevelMild': 'লঘু',
  'hao.caseSheet.riskLevelModerate': 'মধ্যম',
  'hao.caseSheet.riskLevelHigh': 'উচ্চ',
  'hao.caseSheet.treatmentRecommendation': 'চিকিৎসাৰ পৰামৰ্শ',
  'hao.caseSheet.treatmentRecommendationRequired': 'অতি কমেও ৩টা আখৰ দিয়ক।',
  ...
  'hao.closure.callSubType': 'উপ ধৰণক কল কৰক',
  ...
  'hao.closure.feature': 'বৈশিষ্ট্য',
  'hao.closure.selectFeature': 'বৈশিষ্ট্য বাছনি কৰক',
  'hao.closure.followUpDate': 'অনুসৰণৰ তাৰিখ',
  'hao.closure.followUpDateRequired': 'অনুসৰণৰ তাৰিখ আৱশ্যক।',
  'hao.closure.caste': 'জাতি',
  'hao.closure.selectCaste': 'জাতি বাছক',
  'hao.closure.education': 'শিক্ষা',
  'hao.closure.selectEducation': 'শিক্ষা বাছক',
  'hao.closure.externalReferral': 'বাহ্যিক ৰেফাৰেল',
  'hao.closure.selectExternalReferral': 'বাছক',
  'hao.closure.yes': 'হয়',
  'hao.closure.no': 'নহয়',
  ...
  'hao.closure.transferService': 'স্থানান্তৰ কল',
  ...
  'hao.closure.configureMoCampaign': 'অনুগ্ৰহ কৰি মেডিকেল অভিযান কনফিগাৰ কৰক।',
  'hao.closure.configureCampaignGeneric': 'অনুগ্ৰহ কৰি এই সেৱাৰ বাবে এটা অভিযান কনফিগাৰ কৰক।',
  'hao.closure.transferSkill': 'দক্ষতা',
  'hao.closure.selectSkill': 'দক্ষতা বাছনি কৰক',
  'hao.closure.transfer': 'স্থানান্তৰ কল',
  ...
  'supSms.viewTitle': 'এছএমএছ টেমপ্লেট চাওক',
  'supSms.loading': 'ল’ড হৈ আছে…',
  'supSms.sno': 'ক্ৰমিক নং',
  'supSms.templateName': 'টেমপ্লেটৰ নাম',
  'supSms.templateType': 'টেমপ্লেটৰ প্ৰকাৰ',
  'supSms.template': 'টেমপ্লেট',
  'supSms.view': 'চাওক',
  'supSms.actions': 'কাৰ্যসমূহ',
  'supSms.deactivate': 'নিষ্ক্ৰিয় কৰক',
  'supSms.deactivated': 'নিষ্ক্ৰিয় কৰা হৈছে',
  'supSms.deactivatedSuccess': 'সফলতাৰে নিষ্ক্ৰিয় কৰা হৈছে',
  'supSms.noRecords': 'এই সেৱাৰ বাবে এতিয়ালৈকে কোনো এছএমএছ টেমপ্লেট কনফিগাৰ কৰা হোৱা নাই।',
  'supSms.createNew': 'নতুন এছএমএছ টেমপ্লেট সৃষ্টি কৰক',
  'supSms.smsType': 'এছএমএছৰ প্ৰকাৰ',
  'supSms.select': 'নিৰ্বাচন কৰক',
  'supSms.min20': 'কমেও ২০টা আখৰৰ প্ৰয়োজন',
  'supSms.invalidChars':
    'বিশেষ আখৰ ~ ! @ % ^ & * _ + = [ ] { } " ` \' | < > ? ৰ অনুমতি নাই',
  'supSms.paramHint':
    'গতিশীল পেৰামিটাৰবোৰ দুটা ডলাৰ চিহ্নৰ মাজত লিখক, যেনে $$BENEFICIARY_NAME$$',
  'supSms.continue': 'আগবাঢ়ক',
  'supSms.back': 'উভতি যাওক',
  'supSms.cancel': 'বাতিল কৰক',
  'supSms.submit': 'দাখিল কৰক',
  'supSms.selectParameter': 'পেৰামিটাৰ নিৰ্বাচন কৰক',
  'supSms.selectValueType': 'মানৰ প্ৰকাৰ নিৰ্বাচন কৰক',
  'supSms.selectValue': 'মান নিৰ্বাচন কৰক',
  'supSms.add': 'যোগ কৰক',
  'supSms.remove': 'আঁতৰাওক',
  'supSms.parameter': 'পেৰামিটাৰ',
  'supSms.valueType': 'মানৰ প্ৰকাৰ',
  'supSms.value': 'মান',
  'supSms.mapAllParameters': 'দাখিল কৰাৰ আগতে প্ৰতিটো উলিওৱা পেৰামিটাৰক এটা মানৰ সৈতে মেপ কৰক।',
  'supSms.allTypesUsed': 'সকলো এছএমএছ প্ৰকাৰ ব্যৱহাৰ কৰা হৈছে আৰু সেই টেমপ্লেটবোৰ সক্ৰিয় আছে',
  ...
  'supDisease.title': 'ৰোগৰ সাৰাংশ',
  'supDisease.createTitle': 'ৰোগৰ সাৰাংশ সৃষ্টি কৰক',
  'supDisease.editTitle': 'ৰোগৰ সাৰাংশ সম্পাদনা কৰক',
  'supDisease.loading': 'ল’ড হৈ আছে…',
  'supDisease.sno': 'ক্ৰমিক নং',
  'supDisease.diseaseName': 'ৰোগৰ নাম',
  'supDisease.summary': 'ৰোগৰ সাৰাংশ',
  'supDisease.colAdvice': 'চিকিৎসা পৰামৰ্শ',
  'supDisease.actions': 'কাৰ্য',
  'supDisease.edit': 'সম্পাদনা কৰক',
  'supDisease.activate': 'সক্ৰিয় কৰক',
  'supDisease.deactivate': 'নিষ্ক্ৰিয় কৰক',
  'supDisease.confirmActivate': 'আপুনি সঁচাকৈয়ে এই ৰোগৰ সাৰাংশ সক্ৰিয় কৰিব বিচাৰে নেকি?',
  'supDisease.confirmDeactivate': 'আপুনি সঁচাকৈয়ে এই ৰোগৰ সাৰাংশ নিষ্ক্ৰিয় কৰিব বিচাৰে নেকি?',
  'supDisease.noRecords': 'কোনো ৰেকৰ্ড পোৱা নগ’ল',
  'supDisease.pageSize': 'পৃষ্ঠাৰ আকাৰ',
  'supDisease.page': 'পৃষ্ঠা',
  'supDisease.prevPage': 'আগৰ পৃষ্ঠা',
  'supDisease.nextPage': 'পৰৱৰ্তী পৃষ্ঠা',
  'supDisease.nameRequired': 'ৰোগৰ নাম প্ৰয়োজনীয়',
  'supDisease.nameExists': 'ৰোগৰ নাম ইতিমধ্যে আছে',
  'supDisease.questions':
    'তলৰ যিকোনো এটা প্ৰশ্নৰ উত্তৰ হয় হ’লে বিপজ্জনক হ’ব পাৰে',
  'supDisease.causes': 'কাৰণসমূহ',
  'supDisease.dosDonts': 'কি কৰিব আৰু কি নকৰিব',
  'supDisease.symptoms': 'লক্ষণ আৰু চিন',
  'supDisease.whenToSeekAdvice': 'কেতিয়া চিকিৎসা পৰামৰ্শ ল’ব লাগে',
  'supDisease.riskFactors': 'বিপদাশংকাৰ কাৰকসমূহ',
  'supDisease.treatment': 'চিকিৎসা',
  'supDisease.selfCare': 'আত্ম-যত্ন',
  'supDisease.investigations': 'পৰীক্ষা-নিৰীক্ষা',
  'supDisease.linesHint': 'প্ৰতিটো শাৰীত এটাকৈ বিৱৰণ লিখক।',
  'supDisease.back': 'উভতি যাওক',
  'supDisease.reset': 'ৰিছেট কৰক',
  'supDisease.save': 'সংৰক্ষণ কৰক',
  'supDisease.update': 'আপডেট কৰক',
  'supDisease.saved': 'ৰোগৰ সাৰাংশ সফলতাৰে সংৰক্ষণ কৰা হ’ল',
  'supDisease.updated': 'ৰোগৰ সাৰাংশ সফলতাৰে আপডেট কৰা হ’ল',
  'supDisease.saveFailed': 'ৰোগৰ সাৰাংশ সংৰক্ষণ কৰিবলৈ ব্যৰ্থ',
  'supDisease.updateFailed': 'ৰোগৰ সাৰাংশ আপডেট কৰিবলৈ ব্যৰ্থ',
  ...
  'hihl.otherChiefComplaint': 'অন্য মুখ্য অভিযোগ',
  'hihl.duration': 'সময়সীমা',
  'hihl.unitOfDuration': 'সময়সীমাৰ একক',
  'hihl.durationUnit.Hours': 'ঘণ্টা',
  'hihl.durationUnit.Days': 'দিন',
  'hihl.durationUnit.Weeks': 'সপ্তাহ',
  'hihl.durationUnit.Months': 'মাহ',
  'hihl.durationUnit.Years': 'বছৰ',
  'hihl.description': 'বিৱৰণ',
  'hihl.remove': 'আঁতৰাওক',
  'hihl.add': 'যোগ কৰক',
  'hihl.impactOnPatient': 'ৰোগীৰ ওপৰত প্ৰভাৱ',
  'hihl.biologicalFunctioning': 'জৈৱিক কাৰ্যক্ষমতা',
  'hihl.appetite': 'ক্ষুধা',
  'hihl.sleep': 'টোপনি',
  'hihl.bowel': 'পেটৰ গতি',
  'hihl.libido': 'যৌন ইচ্ছা',
  'hihl.hygieneAndTakingCare': 'পৰিষ্কাৰ-পৰিচ্ছন্নতা আৰু নিজৰ যত্ন',
  'hihl.bladder': 'মূত্ৰাশয়',
  'hihl.occupationalFunctioning': 'পেছাগত কাৰ্যক্ষমতা',
  'hihl.goingToWork': 'কামলৈ যোৱা',
  'hihl.issuesAtWorkplace': 'কৰ্মস্থলত সমস্যা',
  'hihl.socialFunctioning': 'সামাজিক কাৰ্যক্ষমতা',
  'hihl.doingOfHouseholdWork': 'ঘৰুৱা কাম কৰা',
  'hihl.gettingAlongWithFamily': "পৰিয়াল, বন্ধু, চুবুৰীয়া আৰু সহকৰ্মীৰ সৈতে খাপ খোৱা",
  'hihl.possiblePrecipitatingFactor': 'সম্ভাৱ্য উদ্দীপক কাৰক',
  'hihl.otherPrecipitatingFactor': 'অন্য উদ্দীপক কাৰক',
  'hihl.treatmentDetails': 'চিকিৎসাৰ বিৱৰণ',
  'hihl.relationshipOfCurrentIllness': 'বৰ্তমানৰ ৰোগৰ সহবৰ্তী চিকিৎসাগত অৱস্থাৰ সৈতে সম্পৰ্ক',
  'hihl.pastHistory': 'পূৰ্বৰ ইতিহাস',
  'hihl.pastPsychiatricCondition': 'পূৰ্বৰ মানসিক ৰোগৰ অৱস্থা',
  'hihl.otherPastPsychiatricCondition': 'অন্য মানসিক ৰোগৰ অৱস্থা',
  'hihl.typeOfTreatment': 'চিকিৎসাৰ ধৰণ',
  'hihl.psychiatricDrugsDetails': 'মানসিক ৰোগৰ ঔষধ / চিকিৎসাৰ বিৱৰণ',
  'hihl.drugDetailsHint': 'ঔষধৰ নাম-শক্তি-মাত্ৰা-বাৰংবাৰতা-সময়সীমা',
  'hihl.course': 'গতি-প্ৰকৃতি',
  'hihl.progress': 'উন্নতি',
  'hihl.pastMedicalCondition': 'পূৰ্বৰ চিকিৎসাগত অৱস্থা',
  'hihl.otherPastMedicalCondition': 'অন্য পূৰ্বৰ চিকিৎসাগত অৱস্থা',
  'hihl.currentMedicationHistory': 'বৰ্তমানৰ ঔষধৰ ইতিহাস',
  'hihl.currentDrugs': 'বৰ্তমানৰ ঔষধসমূহ',
  ...
  'hihl.summary': 'সাৰাংশ',
  'hihl.save': 'সংৰক্ষণ কৰক',
  'hihl.history': 'ইতিহাস',
  'hihl.hideHistory': 'ইতিহাস লুকাওক',
  'hihl.durationGreaterThanAge': "সময়সীমা হিতাধিকাৰীৰ বয়সতকৈ বেছি হ'ব নোৱাৰে।",
  'hihl.confirmRemove': "আপুনি নিশ্চিতভাৱে এই প্ৰৱিষ্টিটো আঁতৰাব বিচাৰেনে?",
  'hihl.saveSuccess': 'কেছ শ্বীট সফলতাৰে সংৰক্ষণ কৰা হ\'ল।',
  'hihl.saveError': "কেছ শ্বীট সংৰক্ষণ কৰিব পৰা নগ'ল। অনুগ্ৰহ কৰি পুনৰ চেষ্টা কৰক।",
  'hihl.history.id': 'ক্ৰম সংখ্যা',
  'hihl.history.gettingAlongWithFamily': 'পৰিয়ালৰ সৈতে খাপ খোৱা',
  'hihl.history.precipitatingFactors': 'সম্ভাৱ্য উদ্দীপক কাৰক',
  'hihl.history.concurrentMedicalCondition': 'সহবৰ্তী চিকিৎসাগত অৱস্থা',
  'hihl.history.pastMedicalConditions': 'পূৰ্বৰ চিকিৎসাগত অৱস্থাসমূহ',
  'hihl.history.currentDrugsMedication': 'বৰ্তমানৰ ঔষধ চিকিৎসা',
  'hihl.history.conditionsInFamily': 'পৰিয়ালত থকা অৱস্থাসমূহ',
  'hihl.history.loading': 'ইতিহাস ল\'ড হৈ আছে…',
  'hihl.history.noRecordFound': "কোনো তথ্য পোৱা নগ'ল।",
