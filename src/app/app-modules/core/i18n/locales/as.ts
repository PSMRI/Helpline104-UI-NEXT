...
export const as: Record<TranslationKey, string> = {
  ...
  'supEmerg.listTitle': 'জৰুৰীকালীন পৰিচয় তালিকা',
  'supEmerg.createTitle': 'জৰুৰীকালীন পৰিচয় সৃষ্টি কৰক',
  'supEmerg.editTitle': 'জৰুৰীকালীন পৰিচয় সম্পাদনা কৰক',
  'supEmerg.sno': 'ক্ৰমিক নং',
  'supEmerg.contactName': 'পৰিচয়ৰ নাম',
  'supEmerg.designation': 'পদবী',
  'supEmerg.location': 'অৱস্থান',
  'supEmerg.contactNumber': 'পৰিচয় নম্বৰ',
