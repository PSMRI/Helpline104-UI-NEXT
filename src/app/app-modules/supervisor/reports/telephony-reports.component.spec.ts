...
import { TelephonyReportsComponent } from './telephony-reports.component';
...
describe('TelephonyReportsComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [TelephonyReportsComponent],
  ...
  function render() {
    const fixture = TestBed.createComponent(TelephonyReportsComponent);
    fixture.detectChanges();
    return fixture;
  }

  it('embeds the CZentrix reporting console once the login key is known, URL-encoding the key', () => {
